...
(function () {
  ...
  registerBlockType('pronamic-pay/crowdfunding-compact', {
    title: pronamic_crowdfunding_compact.title,
    icon: 'marker',
    ...
    edit: function edit(_ref) {
      ...
      var TEMPLATE = [['pronamic-pay/crowdfunding-details', {
        list: [{
          term: pronamic_crowdfunding_compact.term_raised,
          amount: '0,00'
        }, {
          term: pronamic_crowdfunding_compact.term_target,
          amount: '0,00'
        }, {
          term: pronamic_crowdfunding_compact.term_contributions,
          value: '0'
        }]
      }]];
...
//# sourceMappingURL=block-crowdfunding-compact.js.map